...
[uapprox2] = GalerkinMethod(N,f,b,g);
...
h2 = ezplot(uapprox2,[0,1]) ;
h1 = ezplot(uapprox,[0,1]) ;
legend([h1,h2],{['Aproximada MRES: ',char(vpa(uapprox,3)),'(nfun = ', num2str(length(N)),')'],...
               ['Aproximada GALERK: ',char(vpa(uapprox2,3)),'(nfun = ', num2str(length(N)),')']})
